...
class MatchGame extends Component {
  ...
  render() {
    const {activeTabId, score, time, randomImage} = this.state
    ...
    const filteredResults = imagesList.filter(
      eachFruit => eachFruit.category === activeTabId,
    )
      ...
      <div className="main-container">
        ...
        {isGamePlaying ? (
          <div className="bg-container">
            <img src={randomImage.imageUrl} alt="match" className="top-image" />
            <ul className="tabs-container">
              {tabsList.map(eachTab => (
                <TabItem
                  key={eachTab.tabId}
                  tabDetails={eachTab}
                  onChangingFruits={this.onChangeTab}
